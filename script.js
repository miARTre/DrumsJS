...
const animateCrashOrRide = (event) => {
    crashRide.style.transform = "rotate(0deg) scale(1.5)";
};

const animateHiHatClosed = (event) => {
...
const remvoeCrashRideTransition = e => {
...
crashRide.addEventListener("transitionend" , remvoeCrashRideTransition);
